...
<html lang="en">
  <head>
    ...
    <meta id="viewport" name="viewport" content="width=640, minimum-scale=0.5, user-scalable=no">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/lang-'.Lang::getLocale().'.css')}}">
